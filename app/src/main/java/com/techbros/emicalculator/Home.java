    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startcalc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                r = r / 1200; // one month interest
//                t = t * 12; // one month period
//                emi = (p * r * (float)Math.pow(1 + r, t))
//                        / (float)(Math.pow(1 + r, t) - 1);
                double total = (p * r * (float)Math.pow(1 + r, 3)) / (float)(Math.pow(1 + r, 3) - 1)*3;
                listItems.add("3 Installments"+Math.round(p * r * (float)Math.pow(1 + r, 3)/ (float)(Math.pow(1 + r, 3) - 1))+"\tTotal "+Math.round(total));
                listItems.add("6 Installments"+Math.round(p * r * (float)Math.pow(1 + r, 6)/ (float)(Math.pow(1 + r, 6) - 1))+"\tTotal "+Math.round((p * r * (float)Math.pow(1 + r, 6)/ (float)(Math.pow(1 + r, 6) - 1))*6));
